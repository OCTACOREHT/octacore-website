  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-[1.08fr_0.92fr] items-start gap-12">
            <div className="space-y-6 pt-4 lg:pt-8">
              <h1 className="text-foreground text-4xl sm:text-5xl lg:text-6xl font-[family-name:var(--font-heading)] font-bold leading-tight">
      ...
      <section className="bg-background py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 mb-10">
            <p className="text-foreground/60 uppercase tracking-[0.2em] text-xs">About Octacore</p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6">
            <div className="space-y-3 max-w-2xl">
              <p className="text-foreground/60 uppercase tracking-[0.2em] text-xs">Our Expertise</p>
              <h2 className="text-3xl sm:text-4xl font-[family-name:var(--font-heading)] font-bold text-foreground leading-tight">
      ...
      <section className="py-20 sm:py-24 bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 mb-10">
            <p className="text-foreground/60 uppercase tracking-[0.2em] text-xs">Method</p>
            <h2 className="text-3xl sm:text-4xl font-[family-name:var(--font-heading)] font-bold text-foreground leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {processSteps.map((step, index) => (
              <div key={step.title} className="rounded-2xl border border-foreground/10 bg-background/80 p-5 flex flex-col gap-3">
      ...
      <section className="py-20 sm:py-24 bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 mb-10">
            <p className="text-foreground/60 uppercase tracking-[0.2em] text-xs">Commitments</p>
            <h2 className="text-3xl sm:text-4xl font-[family-name:var(--font-heading)] font-bold text-foreground leading-tight">
                ...
                <div className="space-y-3">
                  {item.points.map((point) => (
                    <div key={point} className="flex items-start gap-3">
                      ...
                      <p className="text-foreground/75 text-sm leading-relaxed">{point}</p>
                    </div>
                  ))}
                </div>
              </div>
